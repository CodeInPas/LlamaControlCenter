...
uses
  ...
  ComCtrls, Spin, LCLIntf, DateUtils, uconfigtypes, uchattypes, ugguftypes,
  uggufparser, uhardwareinfo, uprofilemanager, ullamaprocess, uslotmonitor,
  uansiparser, uformatting, ulogger;
