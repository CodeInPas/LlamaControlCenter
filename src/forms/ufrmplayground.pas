...
uses
  ...
  Spin, ColorSpeedButton, DateUtils, fpjson, jsonparser, uchattypes,
  upromptformatter, usseclient, uformatting, uconfigtypes, ujsonhelper, ulogger;

type
  { TfrmPlayground }

  TfrmPlayground = class(TForm)
    btnClearChat: TColorSpeedButton;
    btnInspectModel1: TColorSpeedButton;
    btnSend: TButton;
    btnStop: TButton;
